...
module.exports = class TranslationsManager {
   ...
   * @property {object[]} [messages] An array of the messages extracted by `babel-plugin-react-intl`.
   ...
   * @property {string[]} locales An array of locales to maintain.
  ...
  _buildTemplate() {
    this.template = this.messages.reduce((acc, { id, defaultMessage }) => {
      acc[id] = defaultMessage === undefined ? '' : defaultMessage;
      return acc;
    }, {});
  }
