...
module.exports = class TranslationsManager {
  /**
   * @typedef TranslationsManagerOptions
  ...
  /**
   * @typedef TranslationsManagerResult
  ...
  /**
   * @param {TranslationsManagerOptions} options Options
   */
  constructor(options) {
    this.options = options;
    /** @type {TranslationsManagerResult[]} */
    this.translations = [];
   ...
   * @param {TranslationsManagerResult} result
   * @return {string}
   */
  renderTranslationReport(result) {
  ...
  report() {
    for (let translation of this.translations) {
      console.log(this.renderTranslationReport(translation));
    }
    return this;
  }
   ...
   * @return {TranslationsManagerResult[]}
   */
  results() {
